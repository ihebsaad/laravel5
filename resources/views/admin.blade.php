                                        ...
                                        <div id="lookup" class="tab-pane">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <input ng-change="init()" onchange="checkpin();" onmouseout="checkpin();"  ng-model="search.pin" type="number" name="startsim"  ng-pattern="/^[0-9]*$/" placeholder="PIN #" id="startsim0" class="form-control">
                                                </div>   
												...
												<tr ng-repeat="data in DataPins |  filter : search.pin | limitTo:5">
													<td id="data.pin" style="font-weight:800" ng-bind="data.pin" onclick="SetVal(this)"> </td>
													<td id="data.sim" style=";font-weight:800" ng-bind="data.sim" onclick="SetVal(this)"></td>
												</tr>
												</table> 
												</div> 
												<script> function SetVal(val){alert(val.id);}</script>
