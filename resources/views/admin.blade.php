                ...
                <div class="container">
                    <div class="row">
                      ...
                      <div class="column col-xs-5" id="sidebar">
                                ...
                                <div class="logout col-sm-2" ><a id="logoutb" style="background-color:#006fb9;margin-top:10px;width:100px!important;" href="#" class="btn btn-link-2 " onclick="logout();"> <span   class="glyphicon glyphicon-log-out"></span> Log out</a></div></div></li>
