...
$curl = curl_init();
  ...
  CURLOPT_URL => "https://raniasaad.eu.auth0.com/authorize?response_type=code&client_id=JBL90aJJc4ZG7DxcIfITrYB-UrjbvY_u&connection=databaseserver&redirect_uri=http://test.enterpriseesolutions.com/",
...
curl_setopt_array($curl4, array(
  CURLOPT_URL => "https://raniasaad.eu.auth0.com/v2/logout?client_id=JBL90aJJc4ZG7DxcIfITrYB-UrjbvY_u&returnTo=http://127.0.0.1/laravel5/public/logout",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
if ($err4) {
  echo "   cURL Error logout#:" . $err4;
} else {
  echo '    response logout  '.$response4.'*************';
} 
*/
...
<script type="text/javascript">
  ...
  webAuth.logout({
    returnTo: 'http://test.enterpriseesolutions.com/logout',
    client_id: 'JBL90aJJc4ZG7DxcIfITrYB-UrjbvY_u'
  });
  }
  </script>
