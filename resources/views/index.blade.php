...
<div class="logout col-sm-2" ><a id="logoutb" style="background-color:#006fb9;margin-top:10px;display:none;" href="#" class="btn btn-info " onclick="logout();"> <span   class="glyphicon glyphicon-log-out"></span> Log out</a></div></div></li>
